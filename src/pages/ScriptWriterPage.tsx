...
export function ScriptWriterPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-serif text-3xl font-semibold text-ink dark:text-ink-light sm:text-2xl">Script Writer</h1>
            ...
            {state.reports.map((report: ResearchReport) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-accent-500 dark:text-accent-400 sm:text-xs">{report.topic}</p>
                </div>
              </label>
            ))}
          </div>
